...
public class ModItems {
    ...
    public static final RegistryObject<Item> CONDUCTIUM_INGOT = ITEMS.register("conductium_ingot",
            () -> new Item(new Item.Properties().group(ModItemGroup.DRONECRAFT2_GROUP)));
    public static final RegistryObject<Item> CARBONCONDUCTIUM_COMPOUND = ITEMS.register("carbon_conductium_compound",
            () -> new Item(new Item.Properties().group(ModItemGroup.DRONECRAFT2_GROUP)));
    public static final RegistryObject<Item> CARBONCONDUCTIUM_INGOT = ITEMS.register("carbon_conductium_ingot",
            () -> new Item(new Item.Properties().group(ModItemGroup.DRONECRAFT2_GROUP)));
