...
public class SmallDivideComponent extends DefaultPCBComponent implements IPCBComponent{
    public SmallDivideComponent(int length, int width, PCB_IO[] inputs, PCB_IO[] outputs, RGBA color, PCBSymbol pcbSymbol, TYPE type) {
