...
public class SmallSubtractComponent extends DefaultPCBComponent implements IPCBComponent{
    public SmallSubtractComponent(int length, int width, PCB_IO[] inputs, PCB_IO[] outputs, RGBA color, PCBSymbol pcbSymbol, TYPE type) {
