...
import net.cubic.dronecraft_2.dronecraft_2.block.custom.PCBCrafterBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> PCB_CRAFTER_BLOCK = registerBlock("pcb_crafter_block",
            () -> new PCBCrafterBlock(AbstractBlock.Properties.create(Material.IRON))); //properties area defined in the PCBCrafterBlock class
